...
export function AddImageSS<T extends FieldValues>({ name }: IAddImage<T>) {
  return <AddImageBase size="s" name={name} />;
}

export function AddImageMM<T extends FieldValues>({ name }: IAddImage<T>) {
  return <AddImageBase size="m" name={name} />;
}
